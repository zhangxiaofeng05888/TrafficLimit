 ...
 */
fastmap.dataApi.TipTruckRestriction = fastmap.dataApi.Tip.extend({
    /*
     * 返回参数赋值
     */
...
fastmap.dataApi.tipTruckRestriction = function (data, options) {
    return new fastmap.dataApi.TipTruckRestriction(data, options);
};
