 ...
 */
fastmap.dataApi.TipLeftToRight = fastmap.dataApi.Tip.extend({
    /*
     * 返回参数赋值
     */
...
fastmap.dataApi.tipLeftToRight = function (data, options) {
    return new fastmap.dataApi.TipLeftToRight(data, options);
};
