 ...
 */
fastmap.dataApi.Tip3DBranch = fastmap.dataApi.Tip.extend({
    /*
     * 返回参数赋值
     */
...
fastmap.dataApi.tip3DBranch = function (data, options) {
    return new fastmap.dataApi.Tip3DBranch(data, options);
};
