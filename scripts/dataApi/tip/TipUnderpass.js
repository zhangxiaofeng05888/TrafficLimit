 ...
 */
fastmap.dataApi.TipUnderpass = fastmap.dataApi.Tip.extend({
    /*
     * 返回参数赋值
     */
...
fastmap.dataApi.tipUnderpass = function (data, options) {
    return new fastmap.dataApi.TipUnderpass(data, options);
};
