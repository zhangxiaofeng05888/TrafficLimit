 ...
 */
fastmap.dataApi.TipOrientation = fastmap.dataApi.Tip.extend({
    /*
     * 返回参数赋值
     */
...
fastmap.dataApi.tipOrientation = function (data, options) {
    return new fastmap.dataApi.TipOrientation(data, options);
};
