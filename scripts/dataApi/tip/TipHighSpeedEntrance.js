 ...
 */
fastmap.dataApi.TipHighSpeedEntrance = fastmap.dataApi.Tip.extend({
    /*
     * 返回参数赋值
     */
...
fastmap.dataApi.tipHighSpeedEntrance = function (data, options) {
    return new fastmap.dataApi.TipHighSpeedEntrance(data, options);
};
