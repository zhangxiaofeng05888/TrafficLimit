 ...
 */
fastmap.dataApi.TipElevatedRoad = fastmap.dataApi.Tip.extend({
    /*
     * 返回参数赋值
     */
...
fastmap.dataApi.tipElevatedRoad = function (data, options) {
    return new fastmap.dataApi.TipElevatedRoad(data, options);
};
