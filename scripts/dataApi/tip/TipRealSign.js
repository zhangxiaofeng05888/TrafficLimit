 ...
 */
fastmap.dataApi.TipRealSign = fastmap.dataApi.Tip.extend({
    /*
     * 返回参数赋值
     */
...
fastmap.dataApi.tipRealSign = function (data, options) {
    return new fastmap.dataApi.TipRealSign(data, options);
};
