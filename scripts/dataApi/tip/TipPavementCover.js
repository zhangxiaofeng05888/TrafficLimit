 ...
 */
fastmap.dataApi.TipPavementCover = fastmap.dataApi.Tip.extend({
    /*
     * 返回参数赋值
     */
...
fastmap.dataApi.tipPavementCover = function (data, options) {
    return new fastmap.dataApi.TipPavementCover(data, options);
};
