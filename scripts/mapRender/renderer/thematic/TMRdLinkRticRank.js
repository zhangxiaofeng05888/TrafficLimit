 ...
 */
// RTIC 等级
FM.mapApi.render.renderer.TMRdLinkRticRank = FM.mapApi.render.Renderer.extend({
    ...
    _addNormalSymbol: function () {
        var rdLinkColor = { 0: '#00A500', 1: '#777777', 2: '#C0C0C0', 3: '#FF0000', 4: '#2FFFE3', 5: '#000000', 99: '#64DC14' };
