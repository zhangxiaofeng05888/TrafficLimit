 ...
 */
// link限制信息数量（普通限制信息）
FM.mapApi.render.renderer.TMLinkLimitNum = FM.mapApi.render.Renderer.extend({
    ...
    _addNormalSymbol: function () {
        var rdLinkColor = { 0: '#C0C0C0', 1: '#0000FF', 2: '#FF0000' };
        var color = '';
        if (this._feature.properties.indexNum > 1) {
            color = rdLinkColor[2];
        } else {
