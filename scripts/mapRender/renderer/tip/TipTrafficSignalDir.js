FM.mapApi.render.renderer.TipTrafficSignalDir = FM.mapApi.render.Renderer.extend({
    ...
    getSymbol: function () {
        var waringUrl = '../../images/road/tips/1103/1103_' + this._feature.properties.path + '_0.svg';
        var waringSymbol = {
