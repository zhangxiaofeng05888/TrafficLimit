FM.mapApi.render.renderer.TipRoadName = FM.mapApi.render.Renderer.extend({
    ...
    getSymbol: function () {
        ...
        var waringSymbol = {
            ...
            url: '../../images/road/tips/1901/0.svg',
            width: 18,
            height: 18
        };
        var borderSymbol = {
    ...
    getHighlightSymbol: function () {
        ...
        lineSymbol.geometry = this._geometryFactory.createLineString(this._feature.geometry.geometries[1].coordinates);
