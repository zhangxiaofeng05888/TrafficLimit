FM.mapApi.render.renderer.TipUnderpass = FM.mapApi.render.Renderer.extend({
    ...
    getSymbol: function () {
        ...
        for (var j = 0; j < this._feature.geometry.geometries[2].coordinates.length; ++j) {
            ...
            lineSymbol.geometry = this._geometryFactory.createLineString(this._feature.geometry.geometries[2].coordinates[j]);
            // symbols.push(lineSymbol);
        }
        for (var i = 0; i < 2; i++) {
            var waringUrl = '../../images/road/tips/1505/1505_0_0.svg';
            var waringSymbol = {
