FM.mapApi.render.renderer.TipNormalCross = FM.mapApi.render.Renderer.extend({
    ...
    getSymbol: function () {
        var waringUrl = '../../images/road/tips/1409/0.svg';
        var waringSymbol = {
            ...
            outLine: {
                width: 1,
                color: this._feature.properties.choice == '0' ? this._feature.redFill.lineColor : this._feature.blueFill.lineColor
            }
        };
