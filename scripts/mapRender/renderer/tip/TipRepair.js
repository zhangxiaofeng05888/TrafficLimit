FM.mapApi.render.renderer.TipRepair = FM.mapApi.render.Renderer.extend({
    ...
    getSymbol: function () {
        ...
        // for (var j = 0; j < this._feature.geometry.geometries[3].coordinates.length; j++) {
        //     if (this._feature.geometry.geometries[3].coordinates[j].opt === 1) {
        //         var deleteLinkData = {
        ...
        //         deleteSymbol.geometry = this._geometryFactory.createLineString(this._feature.geometry.geometries[3].coordinates[j].geometry.coordinates);
        //         compositeSymbols.push(deleteSymbol);
        //     }
        //     if (this._feature.geometry.geometries[3].coordinates[j].opt === 2) {
        //         var updateLinkData = {
        //             type: 'SimpleLineSymbol',
        //             color: 'blue',
        //             width: 2
        ...
        //         updateSymbol.geometry = this._geometryFactory.createLineString(this._feature.geometry.geometries[3].coordinates[j].geometry.coordinates);
        //         compositeSymbols.push(updateSymbol);
        //     }
        //     if (this._feature.geometry.geometries[3].coordinates[j].opt === 3) {
        //         var addLinkData = {
        //             type: 'SimpleLineSymbol',
        //             color: 'green',
        //             width: 2
        ...
        //         addSymbol.geometry = this._geometryFactory.createLineString(this._feature.geometry.geometries[3].coordinates[j].geometry.coordinates);
        ...
        for (var i = 0; i < 2; i++) {
            var testSymbol = {
                ...
                url: '../../images/road/tips/1515/1515_0_0.svg',
                width: 18,
                height: 18
            };
            var borderSymbol = {
