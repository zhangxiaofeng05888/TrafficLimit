FM.mapApi.render.renderer.TipTruckSpeedLimit = FM.mapApi.render.Renderer.extend({
    ...
    getSymbol: function () {
        var se = this._feature.properties.se;
        var value = this._feature.properties.value;
        var testSymbol = {
            type: 'ImageMarkerSymbol',
            url: '../../images/road/tips/1114/1114_' + value + '_' + se + '.svg',
            width: 18,
            height: 18
        };
        ...
        var compositeSymbols = [borderSymbol, testSymbol, arrowSymbol, blurSymbol];
        var symbolData = {
