FM.mapApi.render.renderer.TipRoadDirection = FM.mapApi.render.Renderer.extend({
    ...
    getSymbol: function () {
        var waringUrl = '../../images/road/tips/1203/2.svg';
        if (this._feature.properties.choice == 1) {
            waringUrl = '../../images/road/tips/1203/1.svg';
        }
        var waringSymbol = {
