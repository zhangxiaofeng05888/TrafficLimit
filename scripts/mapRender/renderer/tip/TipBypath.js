FM.mapApi.render.renderer.TipBypath = FM.mapApi.render.Renderer.extend({
    ...
    getSymbol: function () {
        ...
        for (var i = 0; i < 2; i++) {
            var testSymbol = {
                ...
                url: '../../images/road/tips/1506/1506_0_0.svg',
                width: 18,
                height: 18
            };
            var borderSymbol = {
            ...
            symbol.geometry = this._geometryFactory.createPoint(i === 0 ? this._feature.properties.startGeo : this._feature.properties.endGeo);
            symbols.push(symbol);
        }
        return symbols;
    },
