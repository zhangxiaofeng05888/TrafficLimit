/**
 * Usage fee required 的前端数据模型
 * @class FM.mapApi.render.data.TMRdLinkLimitType6
 * @author ZhaoHang
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TMRdLinkLimitType6 = FM.mapApi.render.data.Thematic.extend({
    /**
