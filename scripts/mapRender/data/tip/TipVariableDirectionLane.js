/**
 * 可变导向车道 的前端数据模型
 * @class FM.mapApi.render.data.TipVariableDirectionLane
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipVariableDirectionLane = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPVARIABLEDIRECTIONLANE';
        this.properties.lineColor = data.m.a;
