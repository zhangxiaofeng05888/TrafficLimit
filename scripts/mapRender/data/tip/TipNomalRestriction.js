/**
 * 普通交限 的前端数据模型
 * @class FM.mapApi.render.data.TipNomalRestriction
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipNomalRestriction = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPNOMALRESTRICTION';
        this.properties.path = parseInt(data.m.b, 10);
        this.properties.oArray = data.m.d || [];
