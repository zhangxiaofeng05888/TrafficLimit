/**
 * 卡车限速 的前端数据模型
 * @class FM.mapApi.render.data.TipTruckSpeedLimit
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipTruckSpeedLimit = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPTRUCKSPEEDLIMIT';
        this.properties.angle = data.m.c;
        this.properties.se = data.m.d;
        this.properties.value = data.m.e;
