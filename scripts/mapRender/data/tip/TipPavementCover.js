/**
 * 路面无覆盖 的前端数据模型
 * @class FM.mapApi.render.data.TipPavementCover
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipPavementCover = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPPAVEMENTCOVER';
