/**
 * 条件限速 的前端数据模型
 * @class FM.mapApi.render.data.TipSpeedlimit
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipSpeedlimit = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPSPEEDLIMIT';
        this.properties.pathFirst = parseInt(data.m.d, 10);
        this.properties.pathLast = parseInt(data.m.e, 10);
