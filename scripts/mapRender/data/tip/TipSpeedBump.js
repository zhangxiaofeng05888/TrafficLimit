/**
 * 减速带 的前端数据模型
 * @class FM.mapApi.render.data.TipSpeedBump
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipSpeedBump = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPSPEEDBUMP';
        this.properties.path = data.m.e;
