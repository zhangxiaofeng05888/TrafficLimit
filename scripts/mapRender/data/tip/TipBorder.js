/**
 * 接边作业 的前端数据模型
 * @class FM.mapApi.render.data.TipBorder
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipBorder = FM.mapApi.render.data.Tip.extend({
    geometry: {},
    properties: {},
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPBORDER';
    ...
    getGeometry: function (data) {
        ...
        for (var i = 0; i < data.m.c.length; i++) {
            geometry.geometries[1].coordinates.push(data.m.c[i].g);
        }
        geometry.geometries[0].coordinates = data.g;
        return geometry;
    }
});
