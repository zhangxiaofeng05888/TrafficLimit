/**
 * 停车场出入口 的前端数据模型
 * @class FM.mapApi.render.data.TipParkinglot
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipParkinglot = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPPARKINGLOT';
