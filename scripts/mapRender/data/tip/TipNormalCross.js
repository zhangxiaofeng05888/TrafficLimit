/**
 * 普通路口模式图 的前端数据模型
 * @class FM.mapApi.render.data.TipNormalCross
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipNormalCross = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPNORMALCROSS';
        this.properties.path = parseInt(data.m.b, 10);
        this.properties.txt = data.m.d;
        this.properties.choice = data.m.a;
