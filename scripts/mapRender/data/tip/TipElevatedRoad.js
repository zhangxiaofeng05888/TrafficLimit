/**
 * 高架路 的前端数据模型
 * @class FM.mapApi.render.data.TipElevatedRoad
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipElevatedRoad = FM.mapApi.render.data.Tip.extend({
    geometry: {},
    properties: {},
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPELEVATEDROAD';
