/**
 * 高速连接路 的前端数据模型
 * @class FM.mapApi.render.data.TipHighWayConnect
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipHighWayConnect = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPHIGHWAYCONNECT';
        ...
        this.properties.tp = parseInt(data.m.c, 10);
