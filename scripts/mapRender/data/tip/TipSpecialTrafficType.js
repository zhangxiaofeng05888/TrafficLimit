/**
 * 特殊交通类型 的前端数据模型
 * @class FM.mapApi.render.data.TipSpecialTrafficType
 * @author MaLi
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipSpecialTrafficType = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPSPECIALTRAFFICTYPE';
