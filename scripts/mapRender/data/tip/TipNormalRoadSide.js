/**
 * 一般道路方面 的前端数据模型
 * @class FM.mapApi.render.data.TipNormalRoadSide
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipNormalRoadSide = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPNORMALROADSIDE';
