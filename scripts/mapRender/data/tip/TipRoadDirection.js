/**
 * 道路方向 的前端数据模型
 * @class FM.mapApi.render.data.TipRoadDirection
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipRoadDirection = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPROADDIRECTION';
        this.properties.choice = data.m.d;
