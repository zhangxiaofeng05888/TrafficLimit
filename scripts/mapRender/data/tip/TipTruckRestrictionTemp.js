/**
 * 卡车交限 的前端数据模型
 * @class FM.mapApi.render.data.TipTruckRestrictionTemp
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipTruckRestrictionTemp = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPTRUCKRESTRICTION';
