/**
 * 删除在建属性 的前端数据模型
 * @class FM.mapApi.render.data.TipDeletePropertyInProgress
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipDeletePropertyInProgress = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPDELETEPROPERTYINPROGRESS';
        ...
        this.guideLink = this._getGuideLinkGeometry(data.g, data.m.h);
    },

    /**
     * 获取要素模型的引导线几何对象
     * @method _getGuideLinkGeometry
     * @author LiuZhe
     * @date   2017-09-12
     ...
     */
    _getGuideLinkGeometry: function (geo, guide) {
        var geometry = {
            type: 'LineString',
            coordinates: []
        };
