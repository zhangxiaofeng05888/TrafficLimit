/**
 * 路口语音引导 的前端数据模型
 * @class FM.mapApi.render.data.TipCrossVoiceGuide
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipCrossVoiceGuide = FM.mapApi.render.data.Tip.extend({
    geometry: {},
    properties: {},
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPCROSSVOICEGUIDE';
        this.properties.kinds = data.m.d;
    ...
    _getGeometry: function (geo) {
        ...
        for (var i = 0; i < this.properties.kinds.length; i++) {
            geometry.coordinates.push([geo[0] - 15 * (this.properties.kinds.length - 1) + 30 * i, geo[1]]);
        }
        return geometry;
    },
