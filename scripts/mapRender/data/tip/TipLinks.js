/**
 * 测线 的前端数据模型
 * @class FM.mapApi.render.data.TipLinks
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipLinks = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPLINKS';
        this.properties.path = parseInt(data.m.b, 10);
        this.properties.kind = data.m.e.kind;
        this.properties.ln = data.m.e.ln;
        this.properties.cons = data.m.e.cons;
        this.properties.state = parseInt(data.m.d, 10); // 是否打了删除标记 0没有删除 1删除
