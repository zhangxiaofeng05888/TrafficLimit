/**
 * 危险信息 的前端数据模型
 * @class FM.mapApi.render.data.TipWarningInfo
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipWarningInfo = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPWARNINGINFO';
        ...
        this.properties.state = data.m.d;
    ...
    _getGeometry: function (geo) {
        ...
        for (var i = 0; i < this.properties.state.split('|').length; i++) {
            geometry.coordinates.push([geo[0] + (i * 22), geo[1]]);
        }
        return geometry;
    },
