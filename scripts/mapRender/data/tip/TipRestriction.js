/**
 * 点限速 的前端数据模型
 * @class FM.mapApi.render.data.TipRestriction
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipRestriction = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPRESTRICTION';
        this.properties.path = parseInt(data.m.b, 10);
        this.properties.angle = data.m.c;
        this.properties.value = parseInt(data.m.e, 10);
        this.properties.se = parseInt(data.m.d, 10);
        this.properties.flag = parseInt(data.m.f, 10);
