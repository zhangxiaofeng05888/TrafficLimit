/**
 * 草图 的前端数据模型
 * @class FM.mapApi.render.data.TipSketch
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipSketch = FM.mapApi.render.data.Tip.extend({
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPSKETCH';
        ...
        this.properties.nodes = data.m.c;
    ...
    _getGeometry: function (data) {
        ...
        for (var i = 0; i < data.m.c.length; ++i) {
            geom = {
                type: data.m.c[i].t,
                coordinates: data.m.c[i].g
            };
            gc.geometries.push(geom);
        }
