/**
 * 车道数 的前端数据模型
 * @class FM.mapApi.render.data.TipDrivewayMount
 * @author LiuZhe
 * @date   2017-09-12
 *
 * @copyright @Navinfo, all rights reserved.
 */
FM.mapApi.render.data.TipDrivewayMount = FM.mapApi.render.data.Tip.extend({
    geometry: {},
    properties: {},
    /**
    ...
    setAttribute: function (data) {
        this.properties.geoLiveType = 'TIPDRIVEWAYMOUNT';
