...
fastmap.uikit.topoEdit.ADNodeTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    getCreateEditResult: function () {
        ...
        editResult.geoLiveType = 'ADNODE';
        editResult.linkType = 'ADLINK';
        return editResult;
    },
    ...
    query: function (options) {
        var pid = options.pid;
        var p1 = this.dataService.getByPid(pid, options.geoLiveType, options.dbId);
        var param = {
            dbId: options.dbId,
            type: 'ADLINK',
            data: {
    ...
    create: function (editResult) {
        ...
        return this.dataService.createNode('ADNODE', linkPid, data);
    },
    ...
    update: function (editResult) {
        ...
        return this.dataService.moveNode('ADNODE', nodePid, data);
    }
});
