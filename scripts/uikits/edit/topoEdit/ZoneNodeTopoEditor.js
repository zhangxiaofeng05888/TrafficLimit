...
fastmap.uikit.topoEdit.ZoneNodeTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    getCreateEditResult: function () {
        ...
        editResult.geoLiveType = 'ZONENODE';
        editResult.linkType = 'ZONELINK';
        return editResult;
    },
    ...
    create: function (editResult) {
        ...
        return this.dataService.createNode('ZONENODE', linkPid, data);
    },
    ...
    update: function (editResult) {
        ...
        return this.dataService.moveNode('ZONENODE', nodePid, data);
    }
});
