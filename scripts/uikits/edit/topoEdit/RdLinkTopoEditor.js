...
fastmap.uikit.topoEdit.RDLinkTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    /**
     * 修改link方向使用的EditResult
     * @param options
     * @returns {*}
     */
    getChangeLinkDirectEditResult: function (options) {
        var editResult = new fastmap.uikit.complexEdit.LinkDirectResult();
    ...
    create: function (editResult) {
        ...
        return this.dataService.create('RDLINK', data);
    },
    ...
    update: function (editResult) {
        ...
        return this.dataService.repair('RDLINK', objId, data);
    },
     ...
     * @param editResult 编辑结果
     */
    changeLinkDirect: function (editResult) {
        var objectEditCtrl = FM.uikit.ObjectEditController();
        var objId = editResult.originObject.pid;
        var changes = objectEditCtrl.data.getChanges();
        return this.dataService.changeLinkDirect(objId, 'RDLINK', changes);
    },
