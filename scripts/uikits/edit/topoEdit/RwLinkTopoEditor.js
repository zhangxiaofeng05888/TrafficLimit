...
fastmap.uikit.topoEdit.RWLinkTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    create: function (editResult) {
        ...
        return this.dataService.create('RWLINK', data);
    },
    ...
    update: function (editResult) {
        ...
        return this.dataService.repair('RWLINK', objId, data);
    },
