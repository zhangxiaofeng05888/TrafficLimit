 ...
 */
fastmap.uikit.topoEdit.RDMultiDigitizedTopoEditor = L.Class.extend({
    ...
    getCreateEditResult: function (options) {
        var editResult = new fastmap.uikit.complexEdit.UpDownDepartResult();
    ...
    create: function (editResult) {
        ...
        return this.dataService.upDownDepart('RDLINK', data);
    }
});
