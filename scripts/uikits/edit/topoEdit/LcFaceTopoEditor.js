 ...
 */
fastmap.uikit.topoEdit.LCFaceTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    getBuildEditResult: function (options) {
        ...
        editResult.geoLiveType = 'LCFACE';
        editResult.snapFeatureType = 'LCLINK';
        editResult.nodeType = 'LCNODE';
        return editResult;
    },
    ...
    create: function (editResult) {
        ...
        return this.dataService.create('LCFACE', data);
    },
