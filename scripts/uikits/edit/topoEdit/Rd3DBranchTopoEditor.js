...
fastmap.uikit.topoEdit.Rd3DBranchTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    getCreateEditResult: function () {
        ...
        editResult.geoLiveType = 'RD3DBRANCH';
        editResult.branchType = 3;
        return editResult;
    },
    ...
    query: function (options) {
        var pid = options.pid;
        return this.dataService.getBranchByDetailId(pid, 3, options.dbId);
    },
