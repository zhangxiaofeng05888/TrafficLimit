...
fastmap.uikit.topoEdit.RdSignAsRealTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    getCreateEditResult: function () {
        ...
        editResult.geoLiveType = 'RDSIGNASREAL';
        editResult.branchType = 6;
        return editResult;
    },
    ...
    query: function (options) {
        var pid = options.pid;
        return this.dataService.getBranchByDetailId(pid, 6, options.dbId);
    },
