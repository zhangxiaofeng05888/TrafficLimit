...
fastmap.uikit.topoEdit.RdSignBoardTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    getCreateEditResult: function () {
        ...
        editResult.geoLiveType = 'RDSIGNBOARD';
        editResult.branchType = 9;
        return editResult;
    },
    ...
    query: function (options) {
        var pid = options.pid;
        return this.dataService.getBranchByDetailId(pid, 9, options.dbId);
    },
