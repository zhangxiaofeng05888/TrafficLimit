...
fastmap.uikit.topoEdit.RWNodeTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    getCreateEditResult: function () {
        ...
        editResult.geoLiveType = 'RWNODE';
        editResult.linkType = 'RWLINK';
        return editResult;
    },
    ...
    create: function (editResult) {
        ...
        return this.dataService.createNode('RWNODE', linkPid, data);
    },
    ...
    update: function (editResult) {
        ...
        return this.dataService.moveNode('RWNODE', nodePid, data);
    }
});
