...
fastmap.uikit.topoEdit.LULinkTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    create: function (editResult) {
        ...
        return this.dataService.create('LULINK', data);
    },
    ...
    update: function (editResult) {
        ...
        return this.dataService.repair('LULINK', objId, data);
    },
