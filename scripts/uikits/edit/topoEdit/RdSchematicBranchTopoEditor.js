...
fastmap.uikit.topoEdit.RdSchematicBranchTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    getCreateEditResult: function () {
        ...
        editResult.geoLiveType = 'RDSCHEMATICBRANCH';
        editResult.branchType = 8;
        return editResult;
    },
    ...
    query: function (options) {
        var pid = options.pid;
        return this.dataService.getBranchByDetailId(pid, 8, options.dbId);
    },
    ...
    queryDeleteConfirmInfo: function (geoLiveObject) {
        ...
        return this.dataService.getDeleteBranchConfirmInfoByDetailId(pid, branchType);
    },
    ...
    delete: function (geoLiveObject) {
        var pid = geoLiveObject.pid;
        var branchType = geoLiveObject.branchType;
        return this.dataService.deleteBranchByDetailId(pid, branchType);
    }
});
