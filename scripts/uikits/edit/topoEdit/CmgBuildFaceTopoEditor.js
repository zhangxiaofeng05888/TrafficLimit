/**
 * Created by liuzhe on 2017/3/20.
 */

fastmap.uikit.topoEdit.CmgBuildFaceTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    getCreateEditResult: function (options) {
        ...
        editResult.geoLiveType = 'CMGBUILDFACE';
    ...
    getBuildEditResult: function (options) {
        ...
        editResult.geoLiveType = 'CMGBUILDFACE';
        editResult.snapFeatureType = 'CMGBUILDLINK';
        editResult.nodeType = 'CMGBUILDNODE';
        return editResult;
    },
    ...
    create: function (editResult) {
        ...
        return this.dataService.create('CMGBUILDFACE', data);
    },
