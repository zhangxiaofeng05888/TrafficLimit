...
fastmap.uikit.topoEdit.TipTunnelTopoEditor = fastmap.uikit.topoEdit.TipTopoEditor.extend({
    ...
    getCreateEditResult: function (options) {
        ...
        editResult.geoLiveType = 'TIPTUNNEL';
    ...
    create: function (editResult) {
        var tunnelData = fastmap.dataApi.tipTunnel({});
        ...
        return this.dataServiceTips.saveTips(tunnelData, 0);
    },
