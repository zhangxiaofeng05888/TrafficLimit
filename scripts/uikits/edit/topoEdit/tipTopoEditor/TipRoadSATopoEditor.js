...
fastmap.uikit.topoEdit.TipRoadSATopoEditor = fastmap.uikit.topoEdit.TipTopoEditor.extend({
    ...
    getCreateEditResult: function (options) {
        ...
        editResult.geoLiveType = 'TIPROADSA';
    ...
    create: function (editResult) {
        var roadSAData = fastmap.dataApi.tipRoadSA({});
