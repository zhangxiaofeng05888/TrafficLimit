...
fastmap.uikit.topoEdit.TipBridgeTopoEditor = fastmap.uikit.topoEdit.TipTopoEditor.extend({
    ...
    getCreateEditResult: function (options) {
        ...
        editResult.geoLiveType = 'TIPBRIDGE';
    ...
    create: function (editResult) {
        var bridgeData = fastmap.dataApi.tipBridge({});
        bridgeData.deep.gSLoc = this.geometryAlgorithm.precisionGeometry(editResult.startData.pointData, 5);
        bridgeData.deep.gELoc = this.geometryAlgorithm.precisionGeometry(editResult.endData.pointData, 5);
        var array = [];
        ...
        bridgeData.deep.f_array = array;
        bridgeData.geometry.g_location = this.geometryAlgorithm.precisionGeometry(this.getFinalLinksGeo(editResult), 5);
        bridgeData.geometry.g_guide = this.geometryAlgorithm.precisionGeometry(editResult.startData.pointData, 5);
        return this.dataServiceTips.saveTips(bridgeData, 0);
    },
    ...
    update: function (editResult) {
        var bridgeData = editResult.originObject;
        bridgeData.deep.gSLoc = this.geometryAlgorithm.precisionGeometry(editResult.startData.pointData, 5);
        bridgeData.deep.gELoc = this.geometryAlgorithm.precisionGeometry(editResult.endData.pointData, 5);
        var array = [];
        if (editResult.startData.linkData.properties.id === editResult.endData.linkData.properties.id) {
        ...
        bridgeData.geometry.g_location = this.geometryAlgorithm.precisionGeometry(this.getFinalLinksGeo(editResult), 5);
        bridgeData.geometry.g_guide = this.geometryAlgorithm.precisionGeometry(editResult.startData.pointData, 5);
        return this.dataServiceTips.saveTips(bridgeData, 1);
    },
