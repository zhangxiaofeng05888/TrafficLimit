...
fastmap.uikit.topoEdit.TipPedestrianStreetTopoEditor = fastmap.uikit.topoEdit.TipTopoEditor.extend({
    ...
    getCreateEditResult: function (options) {
        ...
        editResult.geoLiveType = 'TIPPEDESTRIANSTREET';
    ...
    create: function (editResult) {
        var pedestrianStreetData = fastmap.dataApi.tipPedestrianStreet({});
        pedestrianStreetData.deep.gSLoc = this.geometryAlgorithm.precisionGeometry(editResult.startData.pointData, 5);
        pedestrianStreetData.deep.gELoc = this.geometryAlgorithm.precisionGeometry(editResult.endData.pointData, 5);
        var array = [];
        ...
        pedestrianStreetData.deep.f_array = array;
        pedestrianStreetData.geometry.g_location = this.geometryAlgorithm.precisionGeometry(this.getFinalLinksGeo(editResult), 5);
        pedestrianStreetData.geometry.g_guide = this.geometryAlgorithm.precisionGeometry(editResult.startData.pointData, 5);
        return this.dataServiceTips.saveTips(pedestrianStreetData, 0);
    },
    ...
    update: function (editResult) {
        var pedestrianStreetData = editResult.originObject;
        pedestrianStreetData.deep.gSLoc = this.geometryAlgorithm.precisionGeometry(editResult.startData.pointData, 5);
        pedestrianStreetData.deep.gELoc = this.geometryAlgorithm.precisionGeometry(editResult.endData.pointData, 5);
        var array = [];
        if (editResult.startData.linkData.properties.id === editResult.endData.linkData.properties.id) {
        ...
        pedestrianStreetData.geometry.g_location = this.geometryAlgorithm.precisionGeometry(this.getFinalLinksGeo(editResult), 5);
        pedestrianStreetData.geometry.g_guide = this.geometryAlgorithm.precisionGeometry(editResult.startData.pointData, 5);
        return this.dataServiceTips.saveTips(pedestrianStreetData, 1);
    },
