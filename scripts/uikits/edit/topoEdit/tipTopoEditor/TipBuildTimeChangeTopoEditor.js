...
fastmap.uikit.topoEdit.TipBuildTimeChangeTopoEditor = fastmap.uikit.topoEdit.TipTopoEditor.extend({
    ...
    getCreateEditResult: function (options) {
        ...
        editResult.geoLiveType = 'TIPBUILDTIMECHANGE';
    ...
    create: function (editResult) {
        var tipBuildTimeChangeData = fastmap.dataApi.tipBuildTimeChange({});
        tipBuildTimeChangeData.deep.gSLoc = this.geometryAlgorithm.precisionGeometry(editResult.startData.pointData, 5);
        tipBuildTimeChangeData.deep.gELoc = this.geometryAlgorithm.precisionGeometry(editResult.endData.pointData, 5);
        var array = [];
        ...
        tipBuildTimeChangeData.deep.f_array = array;
        tipBuildTimeChangeData.geometry.g_location = this.geometryAlgorithm.precisionGeometry(this.getFinalLinksGeo(editResult), 5);
        tipBuildTimeChangeData.geometry.g_guide = this.geometryAlgorithm.precisionGeometry(editResult.startData.pointData, 5);
        return this.dataServiceTips.saveTips(tipBuildTimeChangeData, 0);
    },
    ...
    update: function (editResult) {
        var tunnelData = editResult.originObject;
        tunnelData.deep.gSLoc = this.geometryAlgorithm.precisionGeometry(editResult.startData.pointData, 5);
        tunnelData.deep.gELoc = this.geometryAlgorithm.precisionGeometry(editResult.endData.pointData, 5);
        var array = [];
        if (editResult.startData.linkData.properties.id === editResult.endData.linkData.properties.id) {
            array.push({
                id: editResult.startData.linkData.properties.id.toString(),
        ...
        tunnelData.deep.f_array = array;
        tunnelData.geometry.g_location = this.geometryAlgorithm.precisionGeometry(this.getFinalLinksGeo(editResult), 5);
        tunnelData.geometry.g_guide = this.geometryAlgorithm.precisionGeometry(editResult.startData.pointData, 5);
        return this.dataServiceTips.saveTips(tunnelData, 1);
    },
