/**
 * Created by zhaohang on 2017/5/11.
 */

fastmap.uikit.topoEdit.TipMaintenanceTopoEditor = fastmap.uikit.topoEdit.TipTopoEditor.extend({
    ...
    getCreateEditResult: function (options) {
        ...
        editResult.geoLiveType = 'TIPMAINTENANCE';
    ...
    create: function (editResult) {
        var maintenanceData = fastmap.dataApi.tipMaintenance({});
        maintenanceData.deep.gSLoc = this.geometryAlgorithm.precisionGeometry(editResult.startData.pointData, 5);
        maintenanceData.deep.gELoc = this.geometryAlgorithm.precisionGeometry(editResult.endData.pointData, 5);
        var array = [];
        ...
        maintenanceData.deep.f_array = array;
        maintenanceData.geometry.g_location = this.geometryAlgorithm.precisionGeometry(this.getFinalLinksGeo(editResult), 5);
        maintenanceData.geometry.g_guide = this.geometryAlgorithm.precisionGeometry(editResult.startData.pointData, 5);
        return this.dataServiceTips.saveTips(maintenanceData, 0);
    },
    ...
    update: function (editResult) {
        var maintenanceData = editResult.originObject;
        maintenanceData.deep.gSLoc = this.geometryAlgorithm.precisionGeometry(editResult.startData.pointData, 5);
        maintenanceData.deep.gELoc = this.geometryAlgorithm.precisionGeometry(editResult.endData.pointData, 5);
        var array = [];
        if (editResult.startData.linkData.properties.id === editResult.endData.linkData.properties.id) {
        ...
        maintenanceData.geometry.g_location = this.geometryAlgorithm.precisionGeometry(this.getFinalLinksGeo(editResult), 5);
        maintenanceData.geometry.g_guide = this.geometryAlgorithm.precisionGeometry(editResult.startData.pointData, 5);
        return this.dataServiceTips.saveTips(maintenanceData, 1);
    },
