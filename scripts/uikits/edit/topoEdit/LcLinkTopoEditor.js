...
fastmap.uikit.topoEdit.LCLinkTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    create: function (editResult) {
        ...
        return this.dataService.create('LCLINK', data);
    },
    ...
    update: function (editResult) {
        ...
        return this.dataService.repair('LCLINK', objId, data);
    },
