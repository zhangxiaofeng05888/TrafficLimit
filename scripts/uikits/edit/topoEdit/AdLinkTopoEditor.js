...
fastmap.uikit.topoEdit.ADLinkTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    getCreateEditResult: function () {
        ...
        editResult.snapLinkType = 'ADLINK';
        editResult.geoLiveType = 'ADLINK';
    ...
    create: function (editResult) {
        ...
        return this.dataService.create('ADLINK', data);
    },
    ...
    update: function (editResult) {
        ...
        return this.dataService.repair('ADLINK', objId, data);
    },
