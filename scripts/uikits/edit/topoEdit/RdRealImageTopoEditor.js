...
fastmap.uikit.topoEdit.RdRealImageTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    getCreateEditResult: function () {
        ...
        editResult.geoLiveType = 'RDREALIMAGE';
        editResult.branchType = 5;
        return editResult;
    },
    ...
    query: function (options) {
        var pid = options.pid;
        return this.dataService.getBranchByRowId(pid, 5, options.dbId);
    },
