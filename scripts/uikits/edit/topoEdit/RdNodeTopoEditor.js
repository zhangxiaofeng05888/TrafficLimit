...
fastmap.uikit.topoEdit.RDNodeTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    getCreateEditResult: function () {
        ...
        editResult.geoLiveType = 'RDNODE';
        editResult.linkType = 'RDLINK';
        return editResult;
    },
    ...
    create: function (editResult) {
        ...
        return this.dataService.createNode('RDNODE', linkPid, data);
    },
    ...
    update: function (editResult) {
        ...
        return this.dataService.moveNode('RDNODE', nodePid, data);
    }
});
