...
fastmap.uikit.topoEdit.LUNodeTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    getCreateEditResult: function () {
        ...
        editResult.geoLiveType = 'LUNODE';
        editResult.linkType = 'LULINK';
        return editResult;
    },
    ...
    create: function (editResult) {
        ...
        return this.dataService.createNode('LUNODE', linkPid, data);
    },
    ...
    update: function (editResult) {
        ...
        return this.dataService.moveNode('LUNODE', nodePid, data);
    }
});
