...
fastmap.uikit.topoEdit.RdHighSpeedBranchTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    getCreateEditResult: function () {
        ...
        editResult.geoLiveType = 'RDHIGHSPEEDBRANCH';
        editResult.branchType = 0;
        return editResult;
    },
    ...
    query: function (options) {
        var pid = options.pid;
        return this.dataService.getBranchByDetailId(pid, 0, options.dbId);
    },
