...
fastmap.uikit.topoEdit.RdComplexSchemaTopoEditor = fastmap.uikit.topoEdit.TopoEditor.extend({
    ...
    getCreateEditResult: function () {
        ...
        editResult.geoLiveType = 'RDCOMPLEXSCHEMA';
        editResult.branchType = 4;
        return editResult;
    },
    ...
    query: function (options) {
        var pid = options.pid;
        return this.dataService.getBranchByDetailId(pid, 4, options.dbId);
    },
