...
fastmap.uikit.shapeEdit.TipLaneConnexityTool = fastmap.uikit.shapeEdit.ShapeTool.extend({
    initialize: function () {
        ...
        this.name = 'TipLaneConnexityTool';
    },
    ...
    startup: function () {
        ...
        this.eventController.on(L.Mixin.EventTypes.TIPLANECONNEXITYSPACE, this.enterSpace);
    ...
    shutdown: function () {
        ...
        this.eventController.off(L.Mixin.EventTypes.TIPLANECONNEXITYSPACE);
        this.resetStatus();
    },
