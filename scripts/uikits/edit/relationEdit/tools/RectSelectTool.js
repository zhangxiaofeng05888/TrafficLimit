...
fastmap.uikit.relationEdit.RectSelectTool = fastmap.uikit.relationEdit.RelationTool.extend({
    initialize: function () {
        ...
        this.name = 'RelationRectSelectTool';
    ...
    onLeftButtonDown: function (event) {
        if (!fastmap.uikit.relationEdit.RelationTool.prototype.onLeftButtonDown.apply(this, arguments)) {
            return false;
        }
    ...
    onLeftButtonUp: function (event) {
        if (!fastmap.uikit.relationEdit.RelationTool.prototype.onLeftButtonUp.apply(this, arguments)) {
            return false;
        }
