/**
 * Created by wangmingdong on 2017/2/15.
 */
fastmap.uikit.editControl.BatchModifyTmcControl = fastmap.uikit.editControl.EditControl.extend({
    ...
    onSelectFinish: function (features) {
        ...
        for (var i = 0; i < features.length; ++i) {
            ...
            if (feature.properties.geoLiveType.indexOf('TMC') > -1) {
                items.push(feature);
            }
        }
