...
fastmap.uikit.editControl.BatchConvergePoiLocationControl = fastmap.uikit.editControl.EditControl.extend({
    ...
    run: function () {
        ...
        var editResult = this.topoEditor.getConvergeLocationEditResult();
