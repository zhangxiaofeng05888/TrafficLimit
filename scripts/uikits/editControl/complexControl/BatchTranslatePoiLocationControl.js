...
fastmap.uikit.editControl.BatchTranslatePoiLocationControl = fastmap.uikit.editControl.EditControl.extend({
    ...
    run: function () {
        ...
        var editResult = this.topoEditor.getTranslateLocationEditResult();
    ...
    onUpdateSuccess: function (res) {
        ...
        this.eventController.fire(L.Mixin.EventTypes.REFRESHPOIHIGHLIGHT);
