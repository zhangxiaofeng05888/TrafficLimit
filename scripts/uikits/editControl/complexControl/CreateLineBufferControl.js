...
fastmap.uikit.editControl.CreateLineBufferControl = fastmap.uikit.editControl.EditControl.extend({
    initialize: function (map, geoLiveType) {
        ...
        this.topoEditor = this.topoEditFactory.createBuffer(this.geoLiveType, this.map);
    },
