...
fastmap.uikit.editControl.ModifySamePoiControl = fastmap.uikit.editControl.EditControl.extend({
    ...
    run: function () {
        ...
        var editResult = this.topoEditor.getModifySamePoiResult(this.options);
