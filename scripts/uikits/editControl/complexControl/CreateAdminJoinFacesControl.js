...
fastmap.uikit.editControl.CreateAdminJoinFacesControl = fastmap.uikit.editControl.EditControl.extend({
    initialize: function (map, geoLiveType) {
        ...
        this.topoEditor = this.topoEditFactory.createAdminJoinFacesTopoEditor(this.map);
    },
