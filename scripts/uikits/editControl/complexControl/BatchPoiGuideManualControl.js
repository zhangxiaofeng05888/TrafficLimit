...
fastmap.uikit.editControl.BatchPoiGuideManualControl = fastmap.uikit.editControl.EditControl.extend({
    ...
    run: function () {
        ...
        var editResult = this.topoEditor.getPoiGuideManualEditResult();
            ...
            .then(function (res) {
                ...
                if (res) {
                    return self.topoEditor
                               .updatePoiGuideManual(editResult);
                }
                return null;
            })
