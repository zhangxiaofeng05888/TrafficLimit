 ...
 */
angular.module('app').controller('TipRightEditPanelCtrl', ['$scope', '$rootScope', 'dsLazyload', 'appPath', 'dsFcc',
    function ($scope, $rootScope, dsLazyload, appPath, dsFcc) {
        ...
        var initialize = function () {
            if ($rootScope.CurrentObject) {
                ...
                if (attrTmpl) {
                    dsLazyload.loadInclude($scope, 'tipEditTmpl', appPath.scripts + attrTmpl.ctrl, appPath.scripts + attrTmpl.tmpl).then(function () {
