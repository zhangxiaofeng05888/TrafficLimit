 ...
 */
angular.module('app').controller('RoadRightEditPanelCtrl', ['$scope', '$rootScope', '$timeout', 'dsLazyload',
    'appPath', 'dsEdit',
    function ($scope, $rootScope, $timeout, dsLazyload, appPath, dsEdit) {
        ...
        var initialize = function () {
            if ($rootScope.CurrentObject) {
                ...
                if (attrTmpl) {
                    dsLazyload.loadInclude($scope, 'roadEditTmpl', appPath.scripts + attrTmpl.ctrl, appPath.scripts + attrTmpl.tmpl).then(function () {
