        ...
        var defaultTools027 = [
            {
                ...
                title: '平移显示坐标',
                icon: '平移',
                ngClass: '{\'active\': selectTool.name===\'batchTranslatePoiLocation\'}',
                ngController: 'startEditCtrl',
                ngClick: 'batchTranslatePoiLocation()'
            }, {
                title: '重合显示坐标',
                icon: '重合',
                ngClass: '{\'active\': selectTool.name===\'batchConvergePoiLocation\'}',
                ngController: 'startEditCtrl',
                ngClick: 'batchConvergePoiLocation()'
            }, {
                title: '自动匹配',
                icon: '自动',
                ngClass: '{\'active\': selectTool.name===\'batchPoiGuideAuto\'}',
                ngController: 'startEditCtrl',
                ngClick: 'batchPoiGuideAuto()'
            }, {
                title: '手动指定',
                icon: '手动',
                ngClass: '{\'active\': selectTool.name===\'batchPoiGuideManual\'}',
                ngController: 'startEditCtrl',
                ngClick: 'batchPoiGuideManual()'
            }
        ];
