...
angular.module('app').controller('editToolCtrl', ['$scope', '$timeout', 'hotkeys',
    function ($scope, $timeout, hotkeys) {
        ...
        $scope.onSubToolClick = function (tool) {
            ...
            eventCtrl.fire(L.Mixin.EventTypes.SHAPEEDITTOOLCHANGED, {
                tool: tool
            });
        };

        $scope.onActorCkbClick = function (actor) {
            eventCtrl.fire(L.Mixin.EventTypes.SHAPEEDITSNAPACTORCHANGED, {
                snapActor: actor
            });
        };
        ...
        eventCtrl.on(L.Mixin.EventTypes.OPENSHAPEEDITPANEL, showSubTool);
        eventCtrl.on(L.Mixin.EventTypes.CLOSESHAPEEDITPANEL, hideSubTool);
        eventCtrl.on(L.Mixin.EventTypes.REFRESHSHAPEEDITPANELTOOLS, resetSubTools);
        eventCtrl.on(L.Mixin.EventTypes.REFRESHSHAPEEDITPANELSNAPACTORS, resetSnapActors);
        ...
        $scope.$on('$destroy', function () {
            ...
            eventCtrl.off(L.Mixin.EventTypes.OPENSHAPEEDITPANEL, showSubTool);
            eventCtrl.off(L.Mixin.EventTypes.CLOSESHAPEEDITPANEL, hideSubTool);
            eventCtrl.off(L.Mixin.EventTypes.REFRESHSHAPEEDITPANELTOOLS, resetSubTools);
            eventCtrl.off(L.Mixin.EventTypes.REFRESHSHAPEEDITPANELSNAPACTORS, resetSnapActors);
        });
    }
]);
