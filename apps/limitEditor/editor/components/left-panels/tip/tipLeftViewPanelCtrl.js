 ...
 */
angular.module('app').controller('TipLeftViewPanelCtrl', ['$scope', '$rootScope', 'dsLazyload', 'appPath', 'dsFcc',
    function ($scope, $rootScope, dsLazyload, appPath, dsFcc) {
        ...
        var reloadTipTemplate = function (geoLiveType) {
            ...
            dsLazyload.loadInclude($scope, 'tipLeftViewTmpl', appPath.scripts + tmplFile.ctrl, appPath.scripts + tmplFile.tmpl).then(function () {
