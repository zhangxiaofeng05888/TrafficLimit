App.Config.map.ThematicLayers = {
    rdLinkAppInfo: {
        ...
        options: {
            ...
            render: FM.mapApi.render.renderer.ThematicRender,
            minZoom: 10
        }
    },
    rdLinkDevelopState: {
    ...
    TMRdLinkFcWork: {
        ...
        options: {
            ...
            render: FM.mapApi.render.renderer.FcWorkRender,
            minZoom: 10
        }
    },
    RdObstacle: {
    ...
    TMRdLinkReceiveFree: {
        ...
        options: {
            ...
            featureType: 'RDLINK',
            serverFeatureType: 'rdLinkProperty',
            render: FM.mapApi.render.renderer.ReceiveFreeRender,
            minZoom: 10
        }
    },
    TMRdLinkSpeedRank: {
        ...
        options: {
            ...
            featureType: 'RDLINK',
            serverFeatureType: 'rdLinkProperty',
            render: FM.mapApi.render.renderer.SpeedRankRender,
            minZoom: 10
        }
    },
    rdLinkIMI: {
